...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/flat-grass-4484
```

A live public deployment of this template is available at [https://flat-grass-4484.templates.workers.dev](https://flat-grass-4484.templates.workers.dev)
